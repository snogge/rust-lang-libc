...
extern "C" {
    ...
    #[cfg_attr(
        ...
        link_name = "mkostemp64"
    )]
    pub fn mkostemp(template: *mut ::c_char, flags: ::c_int) -> ::c_int;
    #[cfg_attr(
        all(target_os = "linux", target_env = "gnu", target_pointer_width = "32"),
        link_name = "mkostemps64"
    )]
    ...
    #[cfg_attr(
        ...
        link_name = "__sched_rr_get_interval64"
    )]
    ...
    #[cfg_attr(
        ...
        link_name = "__pthread_mutex_timedlock64"
    )]
